...
1. How to Build
        ...
        - to Build
                $ export ARCH=arm64
                $ make -C $(pwd) O=$(pwd)/out DTC_EXT=$(pwd)/tools/dtc CONFIG_BUILD_ARM64_DT_OVERLAY=y CLANG_TRIPLE=aarch64-linux-gnu- gta4lwifi_eur_open_defconfig
...
3. How to Clean
        ...
        EX) /home/dpi/qb5_8814/workspace/P4_1716/android/out/target/product/gta4lwifi/out
        $ make clean
################################################################################
